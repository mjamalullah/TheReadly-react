...
export const BookingModal = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setIsSubmitted(true);
    showToast(`Free trial booking confirmed for ${formData.student_name}!`, "success");
  };
            ...
            <div className="p-6 sm:p-8 text-center space-y-5 animate-fade-in">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-xs text-left space-y-1.5 text-slate-700 max-w-sm mx-auto">
                <div className="flex justify-between border-b border-slate-200/80 pb-1.5">
                  ...
                  <span className="font-bold text-slate-900">{submittedInfo.name}</span>
                </div>
                <div className="flex justify-between border-b border-slate-200/80 pb-1.5">
                  <span className="text-slate-500">Subject:</span>
                  <span className="font-semibold text-emerald-700">{submittedInfo.subject}</span>
                </div>
                <div className="flex justify-between border-b border-slate-200/80 pb-1.5">
                  <span className="text-slate-500">WhatsApp:</span>
                  <span className="font-medium text-slate-800">{submittedInfo.whatsapp}</span>
                </div>
                <div className="flex justify-between pt-0.5">
                  <span className="text-slate-500">Status:</span>
                  <span className="font-semibold text-emerald-700">Admissions Processing</span>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                <a
                  href={submittedInfo.waUrl}
                  target="_blank"

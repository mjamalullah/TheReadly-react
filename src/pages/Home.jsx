...
export const Home = () => {
  ...
  return (
    <div className="space-y-16 sm:space-y-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="card-base p-8 sm:p-12 bg-white border border-slate-200 hover:border-emerald-500 hover:shadow-lg transition-all rounded-2xl relative overflow-hidden text-left">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 text-left">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="px-2.5 py-1 rounded text-[10px] font-bold uppercase bg-emerald-50 text-[#059669] flex items-center gap-1.5">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#0B4635] font-heading tracking-tight leading-tight">
                Full Online Cambridge O-Level School.{' '}
                <span className="text-[#C59B4B] block mt-1">Study Full O-Level Just Like a Regular School.</span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-2.5 pt-1 text-xs">
                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-800">
                  <span className="text-base">🌅</span>
                  <div>
                    <span className="font-bold text-[#0B4635] block text-xs">Morning Batch</span>
                    <span className="text-slate-500 text-[11px]">9:00 AM – 1:00 PM PKT</span>
                  </div>
                </div>
                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-800">
                  <span className="text-base">🌆</span>
                  <div>
                    <span className="font-bold text-[#936F1E] block text-xs">Evening Batch</span>
                    <span className="text-slate-500 text-[11px]">4:30 PM – 8:30 PM PKT</span>
                  </div>
                </div>
                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-800">
                  <span className="text-base">👥</span>
                  <div>
                    <span className="font-bold text-[#0B4635] block text-xs">Micro-Batches</span>
                    <span className="text-slate-500 text-[11px]">Strictly 6 to 8 students</span>
                  </div>
                </div>
                <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-800">
                  <span className="text-base">🏛️</span>
                  <div>
                    <span className="font-bold text-[#0B4635] block text-xs">British Council</span>
                    <span className="text-slate-500 text-[11px]">Complete exam entry support</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Link
                  ...
                  className="btn btn-teal text-xs sm:text-sm font-bold py-3 px-5 shadow-sm hover:shadow-md transition-all flex items-center gap-2 cursor-pointer"
                >
                ...
                <button
                  type="button"
                  onClick={() => openBookingModal({ curriculum: 'Cambridge O-Level' })}
                  className="btn btn-secondary text-xs font-bold py-3 px-5 flex items-center gap-2 cursor-pointer border-[#C59B4B] text-[#936F1E] hover:bg-[#FEF9EE]"
                >
            ...
            <div className="lg:col-span-5 bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-3.5 text-left shadow-xs">
              <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                <div>
                  <span className="text-[10px] font-extrabold text-[#0B4635] uppercase tracking-wider block">Available Streams</span>
                  <h4 className="text-sm font-extrabold text-slate-900 font-heading">Full Schooling Subjects</h4>
                </div>
                <span className="text-[10px] font-bold bg-[#ECFDF5] text-[#059669] px-2.5 py-0.5 rounded-full border border-emerald-200 font-mono">
                  2026 / 2027 Series
                </span>
              </div>

              <div className="space-y-2 text-xs">
                <div className="p-2.5 rounded-xl bg-white border border-slate-200 flex items-center justify-between hover:border-emerald-300 transition-colors">
                  <span className="font-bold text-slate-800 text-xs">Sciences (Physics, Chem, Bio)</span>
                  <span className="text-[10px] text-[#059669] font-mono font-bold">Theory + ATP Lab</span>
                </div>
                <div className="p-2.5 rounded-xl bg-white border border-slate-200 flex items-center justify-between hover:border-emerald-300 transition-colors">
                  <span className="font-bold text-slate-800 text-xs">Mathematics (4024 / 4037)</span>
                  <span className="text-[10px] text-[#059669] font-mono font-bold">P1, P2 Topical Mocks</span>
                </div>
                <div className="p-2.5 rounded-xl bg-white border border-slate-200 flex items-center justify-between hover:border-emerald-300 transition-colors">
                  <span className="font-bold text-slate-800 text-xs">Languages (English & Urdu)</span>
                  <span className="text-[10px] text-slate-500 font-mono">Directed Writing</span>
                </div>
                <div className="p-2.5 rounded-xl bg-white border border-slate-200 flex items-center justify-between hover:border-emerald-300 transition-colors">
                  <span className="font-bold text-slate-800 text-xs">Pak Studies (2059) & Islamiyat (2058)</span>
                  <span className="text-[10px] text-[#936F1E] font-mono font-bold">Structured Rubrics</span>
                </div>
              </div>

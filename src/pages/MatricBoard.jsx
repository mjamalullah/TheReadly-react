        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-5">
            ...
            <div className="flex items-center gap-2 text-xs font-semibold text-emerald-200/80 mb-2">
              ...
              <span>/</span>
              <span className="text-[#C59B4B] font-bold">Matriculation Board (SSC)</span>
            </div>
            ...
            <div className="pt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-white/10 text-xs">
              <div>
                <span className="text-xl font-black text-[#C59B4B] block">95%+</span>
                <span className="text-slate-300">A+ Grade Target</span>
              </div>
              <div>
                <span className="text-xl font-black text-white block">10-Year</span>
                <span className="text-slate-300">Solved Past Papers</span>
              </div>
              <div>
                <span className="text-xl font-black text-[#C59B4B] block">SLO</span>
                <span className="text-slate-300">Concept-Based Learning</span>
              </div>
              <div>
                <span className="text-xl font-black text-white block">100% Live</span>
                <span className="text-slate-300">Micro-Batches & 1:1</span>
              </div>
            </div>
